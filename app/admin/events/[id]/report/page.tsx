...
function ReportContent() {
  ...
  const exportToCSV = () => {
    ...
    const rows = [
      ...
      ['CO2 Avoided (kg)', Math.round(report.materials.total * 3.5)],
      ['Estimated Savings ($)', Math.round((report.outcomes.fixed + report.outcomes.partially_fixed) * 85)],
      ['Waste Diverted (kg)', report.materials.total],
    ];
