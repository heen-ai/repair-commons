      ...
      <div className="max-w-lg mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <input
            ...
            autoFocus
            className="w-full text-lg px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-green-500 focus:ring-2 focus:ring-green-200 focus:outline-none transition-colors"
          />
